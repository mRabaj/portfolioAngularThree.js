...
export class ModelComponent implements OnInit, AfterViewInit {
  ...
  private createScene() {
    ...
    this.loaderGLTF.load('assets/3d_models/laptop/scene.gltf', (gltf: GLTF) => {
    ...
    this.light1 = new THREE.PointLight(0x0000FF, 10);
    this.light1.position.set(0, 0, 400);
    this.scene.add(this.light1);
    this.light2 = new THREE.PointLight(0x000C66, 10);
 ...
 */
  ...
  ngOnInit(): void {
    var options = {
      strings: ['Je suis développeur web & web mobile.','I am a mobile and web developer.'],
      typeSpeed: 120,
      backSpeed: 100,
      loop: true,
    };
